<div class="flex-middle sr">

<select class="select_wojewodztwa_sr hide_gminy idg std_text_input" type="select" name="lokalizacja_wojewodztwo">
...
<select class="select_powiaty_sr idg std_text_input" type="select" name="lokalizacja_powiat"><option value="" kod="">Miasto / Powiat</option></select>
<select class="select_miasta_gminy_sr idg std_text_input" type="select" name="lokalizacja_miasta_gminy"><option value="" kod="" rodz="">Miejscowość / Gmina</option></select>

<span class="icon-plus add_new_gmi region"></span>
		&nbsp
	<span class="icon-minus remove_region region" style="color: lightgray;"></span>
