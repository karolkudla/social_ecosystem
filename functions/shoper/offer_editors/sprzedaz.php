	...
	<div class="w-90">
		<div class="flex">
			...
			<div class="w-100 required">
				...
				<label><input class="idg" type="radio" name="dodajesz_jako" value="producent">Producent</label>
				<label><input class="idg" type="radio" name="dodajesz_jako" value="posrednik">Pośrednik</label>
				<label><input class="idg" type="radio" name="dodajesz_jako" value="hurtownia">Hurtownia</label>
				<label><input class="idg" type="radio" name="dodajesz_jako" value="dystrybutor">Dystrybutor</label>
				<label><input class="idg" type="radio" name="dodajesz_jako" value="sprzedaz_detaliczna">Sprzedaż detaliczna</label>
			</div>
			...
			<div class="w-100 required">
				...
				<label><input class="idg" type="radio" name="oferta_do" value="hurtownie">Hurtownie</label>
				<label><input class="idg" type="radio" name="oferta_do" value="dystrybutorzy">Dystrybutorzy</label>
				<label><input class="idg" type="radio" name="oferta_do" value="punkty_detaliczne">Punkty detaliczne</label>
...
<div class="step hide all_labels_80" step="3">
		...
		<div class="w-90">
			...
			<div class="flex space-around">
				...
				<div class="w-100">
					...
					<label class="inp">
						<input class="idg required" type="super_text" name="opiekun_imie_nazwisko" placeholder="&nbsp;">
					...
					<div class="super_text_grid">
						<label class="inp">
							<input class="idg required" type="super_text" name="opiekun_tel" placeholder="&nbsp;">
					...
					<div class="super_text_grid">
						<label class="inp">
							<input class="idg required" type="super_text" name="opiekun_email" placeholder="&nbsp;">
				...
				<div class="w-100">
					...
					<div class="super_text_grid">
						<label class="inp">
							<input class="idg required" type="super_text" name="opiekun_firma_nazwa" placeholder="&nbsp;">
					...
					<div class="super_text_grid">
						<label class="inp">
							<input class="idg required" type="super_text" name="opiekun_firma_ulica" placeholder="&nbsp;">
					...
					<div class="super_text_grid">
						<label class="inp">
							<input class="idg required" type="super_text" name="opiekun_firma_miasto" placeholder="&nbsp;">
					...
					<div class="super_text_grid">
						<label class="inp">
							<input class="idg required" type="super_text" name="opiekun_firma_kod_pocztowy" placeholder="&nbsp;">
		...
		<div class="w-90">
			...
			<div class="flex space-around">
				...
				<div class="w-100">
					...
					<div class="super_text_grid">
					<label class="inp">
						<input class="idg required" type="super_text" name="lokalizacja_ulica" placeholder="&nbsp;">
						<span class="label">Ulica</span>
						<span class="border"></span>
					</label>
					</div>
					...
					<div class="super_text_grid">
						<label class="inp">
							<input class="idg required" type="super_text" name="lokalizacja_miasto" placeholder="&nbsp;">
							<span class="label">Miasto</span>
							<span class="border"></span>
						</label>
					</div>
					...
					<div class="super_text_grid">
						<label class="inp">
							<input class="idg required" type="super_text" name="lokalizacja_kod_pocztowy" placeholder="&nbsp;">
							<span class="label">Kod pocztowy</span>
							<span class="border"></span>
						</label>
					</div>
	...
	<div class="shoper_editor_product_line container" container="dane_producenta">
	
		<div class="w-90">
			<div class="about_info text_name">Dane producenta</div>
				...
				<div class="flex space-around">
					...
					<div class="w-100">
						...
						<div class="super_text_grid">
							<label class="inp">
								<input class="idg" type="super_text" name="producent_nazwa" placeholder="&nbsp;">
						...
						<div class="super_text_grid">
							<label class="inp">
								<input class="idg" type="super_text" name="producent_ulica" placeholder="&nbsp;">
								<span class="label">Ulica</span>
								<span class="border"></span>
							</label>
						</div>
						...
						<div class="super_text_grid">
							<label class="inp">
								<input class="idg required" type="super_text" name="producent_miasto" placeholder="&nbsp;">
								<span class="label">Miasto</span>
								<span class="border"></span>
							</label>
						</div>
						...
						<div class="super_text_grid">
							<label class="inp">
								<input class="idg" type="super_text" name="producent_kod_pocztowy" placeholder="&nbsp;">
								<span class="label">Kod pocztowy</span>
								<span class="border"></span>
							</label>
						</div>
					...
					<div class="w-100">
						...
						<div class="super_text_grid">
							<label class="inp">
								<input class="idg" type="super_text" name="producent_nip" placeholder="&nbsp;">
						...
						<div class="super_text_grid">
							<label class="inp">
								<input class="idg" type="super_text" name="producent_regon" placeholder="&nbsp;">
						...
						<div class="super_text_grid">
							<label class="inp">
								<input class="idg" type="super_text" name="producent_krs" placeholder="&nbsp;">
		...
		<div class="w-90">
				...
				<div class="flex">
					...
					<div class="w-100">
						...
						<label><input class="idg" 				 type="radio"  name="cena" value="nie_dotyczy">Nie dotyczy</label>
...
<div class="step hide" step="5">
	...
	<div class="shoper_editor_product_line container" container="gwarancje">
		...
		<div class="w-90">
			...
			<div class="flex">
				<div class="w-100">
					<div class="shoper_editor_inline_header text_name">Gwarancja</div>
					<label><input class="idg" type="radio"  name="gwarancja" value="brak_gwarancji">Brak gwarancji</label>
					<label><input class="idg" type="radio"  name="gwarancja" value="gwarancja_sprzedajacego">Gwarancja sprzedającego</label>
					<label>
						<select class="idg" type="select" name="gwarancja_sprzedajacego_wartosc">
							<option></option>
					...
					<label><input class="idg" type="radio"  name="gwarancja" value="gwarancja_producenta">Gwarancja producenta</label>
					<label>
						<select class="idg" type="select" name="gwarancja_producenta_wartosc">
							<option></option>
							<option>1 miesiąc</option>
							<option>2 miesiące</option>
							<option>3 miesiące</option>
				...
				<div class="w-100">
					<div class="shoper_editor_inline_header text_name">Ubezpieczenie OC sprzedawcy</div>
					<label><input class="idg" type="radio"  name="ubezpieczenie_oc_sprzedawcy" value="brak_ubezpieczenia">Brak ubezpieczenia OC</label>
					<label><input class="idg" type="radio"  name="ubezpieczenie_oc_sprzedawcy" value="ubezpieczenie_do_kwoty">Ubezpieczenie do kwoty</label>
					<label>
			...
			<div class="w-100">
				...
				<div class="flex">
					<label><input class="idg" type="radio"  name="odstapienie_od_umowy" value="do_x_dni">Wystawca oferty uwzględnia prawo kupującego do odstąpienia od umowy zakupu na dowolnym etapie jego realizacji w terminie do X dni od daty zawarcia transakcji</label>
					<label>
