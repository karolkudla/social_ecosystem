...
<div class="one_offer_card one_offer_multimedia">

	<div class="one_offer_multimedia--youtube_slick">
	<?php
		if (strlen($p['yt']) > 5) {
	...
	<?php	}
		} else {echo '<div style="padding: 10px; font-size: 13px;">Brak multimediów</div>';}		
	?>
	</div>
