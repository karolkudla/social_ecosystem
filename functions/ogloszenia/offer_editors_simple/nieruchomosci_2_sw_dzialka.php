<div class='about_info p30'>Działka</div>
		...
		<div class="about_info text_name">Informacje szczegółowe o oferowanym lokalu</div>
			...
			<div class="flex">
				...
				<div class="w-100">
					...
					<div class="flex space-between">
						<label class="text_name">Typ działki</label>
						<label>
							<select class="idg std_text_input" type="select" name="typ_dzialki">
								<option></option>
								<option>Budowlana</option>
								<option>Rolna</option>
								<option>Rekreacyjna</option>
								<option>Pod inwestycje</option>
								<option>Leśna</option>
								<option>Rolno - budowlana</option>
								<option>Siedliskowa</option>
							</select>
						</label>
					</div>
